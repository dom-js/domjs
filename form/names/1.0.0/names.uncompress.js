...
define(["jquery","base/objectj","m!widget/dropdown:1.0.0","m!store/reststore:1.0.0","i18n!nls/system","appinfo","base/util"],
    function ($,obj,dropdown,Store,i18n,appinfo,util) {
        ...
        SelectPanel.fn.extend({
            ...
            __copy:function(){
                ...
                if(window.clipboardData) {
                    ...
                    try {
                        ...
                        require(["widget/jbox"],function(jbox){
                            var buttons={}
                            buttons[i18n["OK"]]=0
                            jbox.alert("被浏览器拒绝！\n请在浏览器地址栏输入'about:config'并回车\n然后将 'signed.applets.codebase_principal_support'设置为'true'"+"<p>"+txt+"</p>",i18n["Tips"],{
                                buttons:buttons
                            })
                        })
                    ...
                    require(["widget/jbox"],function(jbox){
                        var buttons={}
                        buttons[i18n["OK"]]=0
                        jbox.alert(i18n["The browser does not support auto-copy, manually copy the following text."]+"<p>"+txt+"</p>",i18n["Tips"],{
                            buttons:buttons
                        })
                    })
                    return false
                ...
                require(["widget/jbox"],function(jbox){
                    var buttons={}
                    buttons[i18n["OK"]]=0
                    jbox.alert(i18n["Copy success."],i18n["Tips"],{
                        buttons:buttons
                    })
                })
            },
            ...
            refresh:function(_position){
                if(this.options.valuelist.length>0){
                    ...
                    var _height = this.height(),
                        _width =  this.width()>_pos.width?this.width():_pos.width;
                    var _left = _pos.left
        ...
        autoComplete.fn.extend({
            main:function (selector, context) {
                ...
                if(this.data("form/names")) return this.data("form/names")
            ...
            __initStore:function(){
                ...
                }else if((typeof this.options.store =="undefined")||this.options.store==null){
                    this.store = new Store({
                        url: appinfo.hrwspath+"getEmpinfo.action" //this.options.storeurl
                    })
                }else{
                    ...
                    var showDialog=function(){
                        ...
                        try{
                            ...
                            if (selectValue||selectValue=="") {
                                ...
                                //_self.__queryEvent(window.event)
                            }
                        }catch(e){}
                    }

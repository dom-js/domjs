 ...
 * @ 20140619 重构form，重新优化事件机制
 */
define(function(require,exports,module){
var $  = require("jquery"),
    obj = require("base/objectj"),
    appinfo = require("appinfo"),
    docinfo = require("docinfo"),
    util=require("base/util");
    require("css!./theme/css/form");
    var form = exports = module.exports = obj.sub();
    form.fn.extend({
        main:function(selector,options){
            ...
            if(this.data("form.form"))
                ...
                this.data("form.form",this);
            util.translate("nls/form","div.admin_Tools");
            this.extend(this.options,options);
            this.initAdmintools();
        },
        options : {
            vaildateaction:"submit",
            isLock : !doc.isnewdoc ,
        ...
        initAdmintools:function() {
            $(this).on("click","#idAdministratorTools",function(){
                var url = appinfo.dbpath +"/fmAdminTools?openform&unid="+docinfo.unid;
                var params = {
                    height:250,
                    width:500,
                    ...
                    resizable:"no",
                    status:"no"
                },p =  $.param(params).replace(/&/g,",")
                var adminWin = window.open(url,p);

            });
        }
    })
   // if(!this.data("com.hik.notes.form"))
});
define(

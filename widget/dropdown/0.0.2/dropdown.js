...
define(["jquery"],function($){
    ...
    DropDown.panel =function(ops){
        ...
        if(this.isCreated ||!this.contentPanel.is("[jId=dpnames]")) {
            this.contentPanel = $("<div data-type='dropdown' style='position:absolute;z-index:9999;display:none;background-color:#FFF;border:\" solid  1px #ccc\"' jId='"+this.jId+"'>").css({
                position:"absolute"
            });
            if(this.classname){
        ...
        this.addEntry=function(el){
            var entry = $("<li class='drowdownli' tabindex='1' >");
            ...
            entry.on("keydown",function(e){
                ...
                switch(e.which){
                    ...
                    case 40:
                        ...
                        break;
                    case 13:
                        var entryItem = el.data("entryItem")
                        entryItem.drop._selected(entryItem.item,el)
                        return false;
                        break;
                }
                return false;

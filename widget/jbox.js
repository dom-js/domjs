define( [ "jquery", "widget/jbox/jbox.2.3.min","css!"+require.toUrl("widget/jbox/skins/hikgray/jbox.css")], function($) {

    /* jBox 全局设置 */
    var jBoxConfig = {};
   //require(["css!"+require.toUrl("widget/jbox/skins/hikgray/jbox.css")])
    jBoxConfig.defaults = {
    ...
    try{
        ...
        $.jBox.defaults.dragLimit = false;
        $.jBox.defaults.top = "25%";
        $.jBox.defaults.border = 0;
        $.jBox.defaults.opacity = 0.2;
        $.jBox.defaults.title = "操作提示窗口";
    }catch(e){
